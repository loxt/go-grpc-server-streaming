...
const (
	HelloService_SayHello_FullMethodName       = "/proto.v1.HelloService/SayHello"
	HelloService_BeatsPerMinute_FullMethodName = "/proto.v1.HelloService/BeatsPerMinute"
)
...
func (c *helloServiceClient) BeatsPerMinute(ctx context.Context, in *BeatsPerMinuteRequest, opts ...grpc.CallOption) (HelloService_BeatsPerMinuteClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], HelloService_BeatsPerMinute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.v1.HelloService",
